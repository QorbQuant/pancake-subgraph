...
// prettier-ignore
const WETH_ADDRESS = "0xFC00000000000000000000000000000000000006"; // wfrxETH
// prettier-ignore
const USDC_WETH_03_POOL = "0xFC00000000000000000000000000000000000006"; // wfrxETH/FRAX

const STABLE_IS_TOKEN0 = "0xFc00000000000000000000000000000000000001" as string; // FRAX

// token where amounts should contribute to tracked volume and liquidity
// usually tokens that many tokens are paired with s
// prettier-ignore
export let WHITELIST_TOKENS: string[] = "0xFC00000000000000000000000000000000000005".split(","); // sfrxETH

// prettier-ignore
let STABLE_COINS: string[] = "0xFc00000000000000000000000000000000000001".split(","); // FRAX
